...
export const instrutoresMock: Instrutor[] = [
  ...
  { id: "8",  nome: "Liriana",   cor: "#534AB7", especialidades: ["Yoga"],                terceirizado: false },
  { id: "9",  nome: "Ticiana",   cor: "#854F0B", especialidades: ["Yoga"],                terceirizado: false },
  { id: "10", nome: "Manu",      cor: "#085041", especialidades: ["Bike", "Hit Dance"],   terceirizado: false },
  { id: "11", nome: "Jane",      cor: "#639922", especialidades: ["Musicalização"],       terceirizado: false },
  { id: "12", nome: "Marion",    cor: "#A32D2D", especialidades: ["Dança de Salão"],      terceirizado: false },
